...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    homeText: Attribute.Text;
    aboutUsText: Attribute.Text;
...
export interface ApiSlidingWallSlidingWall extends Schema.SingleType {
  ...
  info: {
    singularName: 'sliding-wall';
    pluralName: 'sliding-walls';
    displayName: 'Posuvn\u00E9 steny';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiWardrobeWardrobe extends Schema.CollectionType {
  collectionName: 'wardrobes';
  info: {
    singularName: 'wardrobe';
    pluralName: 'wardrobes';
    displayName: '\u0160at\u0148ov\u00E9 skrinky';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    title: Attribute.String;
    items: Attribute.Component<'products.items', true>;
    parameters: Attribute.RichText &
      Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'toolbar';
